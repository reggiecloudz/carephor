...
class Position(models.Model):
    ...
    people_needed = models.PositiveIntegerField(_("people_needed"), default=1, null=False, blank=True)
    ...
    campaign = models.ForeignKey(Campaign, verbose_name=_("campaign"), on_delete=models.CASCADE, related_name="positions", null=False, blank=True)
